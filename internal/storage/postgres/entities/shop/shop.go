...
func (is *Items) GetItems(storage *postgres.Storage) error {
...
type InCartItems []InCartItem

func (icis *InCartItems) GetInCartItems(storage *postgres.Storage, cartID int) error {
